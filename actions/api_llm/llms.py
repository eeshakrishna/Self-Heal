...
class OpenAI:
    def __init__(
        ...
        completions_model=os.environ.get(
            "OPENAI_COMPLETIONS_MODEL", "gpt-3.5-turbo-0125"
        ),
        ...
        completions_api_key=os.environ.get("OPENAI_COMPLETIONS_API_KEY","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"),
    ):
